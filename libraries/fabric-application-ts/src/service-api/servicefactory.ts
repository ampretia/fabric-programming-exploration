...
export default class ServiceFactory {
    ...
    /**
     * Configure the factory, by connecting to the gateway with the specified identity
     * 
     * @param gatewayProfilePath Connection Profile for the gateway peer
     * @param wallet Wallet implemetnation
     * @param identity Identity Label to use
     */ 
