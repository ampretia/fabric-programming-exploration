...
import { JSONSerializer } from 'fabric-data';
 ...
 * 
 * Maps 1:1 to the Contract objects in the chaincode container, specific services should subclass this class
 * and use it's features to support specific implementations
 */
export default class Service {
    ...
    /**
     * 
     * @param network Network object to connect to 
     * @param schema Schema that describes the service
     */
