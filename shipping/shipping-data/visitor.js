...
class MetadataVisitor {
    ...
    visitModelFile (modelFile, parameters) {
        ...
        modelFile.getAssetDeclarations().filter((declaration) => {
            ...
            parameters.first = true;
            let s = declaration.accept(this, parameters);
    ...
    visitTransactionDeclaration (transactionDeclaration, parameters) {
        ...
        let contractDecorator = transactionDeclaration.getDecorator('contract');
        console.log(contractDecorator.getArguments())
        let {name : contractName} = contractDecorator.getArguments()[0]
...
module.exports = MetadataVisitor;
