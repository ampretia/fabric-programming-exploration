...
class MetadataVisitor {
    ...
    visit(thing, parameters) {
        if (thing instanceof composer_concerto_1.ModelManager) {
            return this.visitModelManager(thing, parameters);
        }
        else if (thing instanceof composer_concerto_1.ModelFile) {
            return this.visitModelFile(thing, parameters);
        }
        else if (thing instanceof composer_concerto_1.AssetDeclaration) {
            return this.visitAssetDeclaration(thing, parameters);
        }
        else if (thing instanceof composer_concerto_1.TransactionDeclaration) {
            return this.visitTransactionDeclaration(thing, parameters);
        }
        else if (thing instanceof composer_concerto_1.EnumDeclaration) {
            return this.visitEnumDeclaration(thing, parameters);
        }
        else if (thing instanceof composer_concerto_1.ConceptDeclaration) {
            return this.visitConceptDeclaration(thing, parameters);
        }
        else if (thing instanceof composer_concerto_1.ClassDeclaration) {
            return this.visitClassDeclaration(thing, parameters);
        }
        else if (thing instanceof composer_concerto_1.Field) {
            return this.visitField(thing, parameters);
        }
        else if (thing instanceof composer_concerto_1.RelationshipDeclaration) {
            return this.visitRelationshipDeclaration(thing, parameters);
        }
        else if (thing instanceof composer_concerto_1.EnumValueDeclaration) {
...
exports.default = MetadataVisitor;
